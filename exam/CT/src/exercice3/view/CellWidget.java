...
public class CellWidget extends JButton implements Observer {
	...
	static {
		try {
			...
			BufferedImage buffImgFlag = ImageIO.read(Util.class.getClassLoader().getResource("exercice3/flag.jpg"));
			FLAG = new ImageIcon(buffImgFlag.getScaledInstance(PREFERED_SIZE.width, PREFERED_SIZE.height, Image.SCALE_SMOOTH));
