...
public class JBox extends JButton implements Observer {
	...
	private static ImageIcon MINE,FLAG;
	...
	static {
		try {
			...
			BufferedImage buffImg1 = ImageIO.read(Util.class.getClassLoader().getResource("exercice3/flag.jpg"));
			FLAG = new ImageIcon(
					buffImg1.getScaledInstance(PREFERED_SIZE.width, PREFERED_SIZE.height, Image.SCALE_SMOOTH));
			buffImg1 = ImageIO.read(Util.class.getClassLoader().getResource("exercice3/flag.jpg"));
